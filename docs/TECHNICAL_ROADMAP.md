# IELTS Codex — Technical Roadmap

This document is the detailed English technical reference for IELTS Codex.
The public-facing Chinese overview lives in [../README.md](../README.md).

It covers the interactive command surface, the pixel-art game mode,
vocabulary data and provenance, the manual update flow, progress storage,
and spaced-repetition behaviour.
